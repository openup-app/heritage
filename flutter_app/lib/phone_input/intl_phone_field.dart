  ...
  void initState() {
    ...
    if (number.startsWith('+')) {
      number = number.replaceFirst(
          RegExp("^\\+${widget.country.fullCountryCode}"), "");
    } else {
      number =
          number.replaceFirst(RegExp("^${widget.country.fullCountryCode}"), "");
    }

    if (widget.autovalidateMode == AutovalidateMode.always) {
      final initialPhoneNumber = PhoneNumber(
        countryISOCode: widget.country.code,
        countryCode: '+${widget.country.dialCode}',
        number: widget.initialValue ?? '',
      );
    ...
    return TextFormField(
      ...
      onSaved: (value) {
        widget.onSaved?.call(
          PhoneNumber(
            countryISOCode: widget.country.code,
            countryCode:
                '+${widget.country.dialCode}${widget.country.regionCode}',
            number: value!,
          ),
        );
      },
      onChanged: (value) async {
        final phoneNumber = PhoneNumber(
          countryISOCode: widget.country.code,
          countryCode: '+${widget.country.fullCountryCode}',
          number: value,
        );
      ...
      validator: (value) {
        ...
        if (!widget.disableLengthCheck) {
          return value.length >= widget.country.minLength &&
                  value.length <= widget.country.maxLength
              ? null
      ...
      maxLength: widget.disableLengthCheck ? null : widget.country.maxLength,
    ...
    return Container(
      ...
      child: DecoratedBox(
        ...
        child: InkWell(
          ...
          onTap: widget.enabled ? widget.onPickCountry : null,
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  kIsWeb
                      ? Image.asset(
                          'assets/images/flags/${widget.country.code.toLowerCase()}.png',
                          width: 32,
                        )
                      : Text(
                          widget.country.flag,
